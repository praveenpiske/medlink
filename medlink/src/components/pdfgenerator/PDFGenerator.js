...
const PDFGenerator = ({name, age, gender, selectedDoc}, prescription) => {
    ...
    pdf.text("MEDLINK", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("MEDLINK") * pdf.internal.getFontSize())), y);
    y += 30;
    ...
    y += 20;
    pdf.text("medlink@gmail.com", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("medlink@gmail.com") * pdf.internal.getFontSize())), y);
    y += 25;
    ...
    pdf.text("2024 @MedLink| All Rights Reserved", pdf.internal.pageSize.width - 40 - pdf.getStringUnitWidth("2024 @MedLink | All Rights Reserved") * pdf.internal.getFontSize(), pdf.internal.pageSize.height - 30);
