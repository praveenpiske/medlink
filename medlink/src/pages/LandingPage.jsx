  ...
  const faqs = [
    {
      ...
      answer:
        "It is the web application that connects patients to the right doctor or allow them to choose a doctor as per their need, It also allows users to create instant meetings with doctors.",
    },
    {
      question:
        "Can we get a free account in MedLink and use all its features for free?",
      answer:
        "Yes, Ofcourse. You can use all the features provided by MedLink for free.",
    },
    {
      ...
      <div id="landing-page">
        <section className="intro-section">
          ...
          <div className="content">
            <div className="text">
              <h2>
                Take best quality treatments <br />
        ...
        <section className="features-section">
          ...
          <div className="features">
            ...
            <div className="item">
              ...
              <p>
                You can test your health whether you have a possibility of
                disease or not.
              </p>
            </div>
            <div className="item">
              ...
              <p>
                You can purchase medicines through our pharmacy store with
